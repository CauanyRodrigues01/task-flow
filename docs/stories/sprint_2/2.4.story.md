...
- [x] **Frontend: Componentes** (CA: 1, 2, 3, 4, 5)
  - [x] Criar um componente `TaskFilters.tsx` com controles para status, responsável, prioridade e um campo de busca.
  - [x] Integrar o estado dos filtros com a chamada à API para buscar as tarefas.
  - [x] Garantir que as visualizações de lista e Kanban sejam atualizadas quando os filtros são aplicados.
- [x] **Testes** (CA: 6)
...
- `taskflow-frontend/projects.html` (modificado)
- `taskflow-frontend/assets/js/react/task-components.js` (modificado)
