...
- [x] **Frontend: Componentes** (CA: 1, 2, 3, 4)
  - [x] Desenvolver o componente `TaskList.tsx`.
  - [x] Desenvolver o componente `KanbanBoard.tsx` com colunas de status.
  - [x] Implementar a funcionalidade de arrastar e soltar e a chamada à API `PATCH` correspondente.
- [x] **Testes** (CA: 6)
