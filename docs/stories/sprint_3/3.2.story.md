...
- [x] **Backend: Testes** (CA: 6)
  - [x] Escrever testes unitários para `NotificationService` usando JUnit 5 e Mockito.
  - [x] Escrever testes de integração para `NotificationController` usando `@SpringBootTest`.
